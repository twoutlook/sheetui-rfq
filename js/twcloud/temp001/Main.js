...
//        var ddlMaterial = {data: "xxx", drop: Ext.encode({data: "xxx,yyy,zzz"})};
    var ddlMaterial = {ta: "center", data: "===材质规格===", drop: Ext.encode({data: "一。铝合金,AlSi10Mg,AlSi9Cu3,ADC12,A380,A413,A360,A356,二。锌合金 ,ZINC-2,ZINC-3,ZINC-5,ZINC-7,ZAMAK-8,三。镁合金 ,AZ91D,AM60,THX-AZ91D,THX-AM60"})};
    var ddlSurface = {ta: "center", data: "===表面要求===", drop: Ext.encode({data: "单清洗,烤漆前皮膜（含清洗）,铝合金一般皮膜（48H）,锌合金一般皮膜（48H),镁合金一般皮膜（24H),铝合金-特殊皮膜（   H）,锌合金-特殊皮膜（   H) ,特殊导电皮膜(  欧姆) ,粉體烤漆-A+級,粉體烤漆-A級 ,粉體烤漆-B級 ,液體烤漆-A+級 ,液體烤漆-A級 ,液體烤漆-B級 ,阳极氧化-A级 , 阳极氧化-B级 ,电泳-A级,电泳-B级 ,掛鍍-A級,掛鍍-B 級,滾鍍-A級,滾鍍-B級 ,高清洁度清洗（600um）,高清洁度清洗（400um）,高清洁度清洗（200um）"})};
    var ddlMachine = {ta: "center", data: "===适用机型===", drop: Ext.encode({data: "一。铝合金压铸合模费：,铝-125T,鋁-150T/160T/200T,鋁-250T/280T,鋁-350T/340T/400T,鋁-550T/530T/500T,鋁-630T/650T,鋁-800T/900T,鋁-1250T,鋁-1600T,鋁-2000T,鋁-2500T,鋁-3000T,二。锌合金压铸合模费：,鋅-快速机/4轴机,鋅-10T/5T,鋅-15T/20T,鋅-25T/30T/40T,鋅-50T/60T,鋅-80T/100T/125,鋅-150T,鋅-185/200T,鋅-250T,鋅-300T,三。镁合金压铸合模费：,鎂-150T,鎂-340T/400T,鎂-530T/660T,THX-鎂280T,THX-鎂650T"})};
...
//var colorStepEnd="#A9BCF5";
    ...
    function styleSubTotal(source2) {
        ...
        //http://stackoverflow.com/questions/18498801/how-to-merge-two-object-values-by-keys
    ...
    var json = {
        ...
        sheets: [{id: 1, name: "RFQ001", actived: true, color: "orange"}, {id: 2, name: "LOOKUP", actived: true, color: "blue"}, {id: 3, name: "LOOKUP2", actived: true, color: "blue"}, {id: 5, name: "LOOKUP04", actived: true, color: "blue"}],
//        floatings: [
...
//                    {sheet: 1, row: 2, col: 3, json: {data: "0"}},
            ...
            {sheet: 1, row: 38, col: 3, json: styleSubTotal({data: "=(C32+C36+C37)"})},
            {sheet: 1, row: 39, col: 1, json: {data: "* "}},
            {sheet: 1, row: 39, col: 2, json: {bgc: colorStep, data: "2)压铸费(含切边）： "}},
            {sheet: 1, row: 39, col: 3, json: {data: ""}},
...
//            {sheet: 1, row: 58, col: 3, json: {data: ""}},
            ...
            {sheet: 1, row: 73, col: 3, json: styleSubTotal({data: "=(C71/3600)*C72"})},
...
//            {sheet: 1, row: 77, col: 3, json: {bgc: colorStepEnd, fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C75/3600)*C76"}},
            {sheet: 1, row: 77, col: 3, json: styleSubTotal({data: "=(C75/3600)*C76"})},
            ...
            {sheet: 1, row: 82, col: 3, json: {fm: "number", dfm: "0.0", data: "1"}},
            ...
            {sheet: 1, row: 97, col: 3, json: {data: "56"}},
            {sheet: 1, row: 98, col: 1, json: {data: "12-2）"}},
            {sheet: 1, row: 98, col: 2, json: {data: "气测费/只 "}},
            {sheet: 1, row: 98, col: 3, json: {fm: "money|¥|2|none", data: "0.78"}},
            ...
            {sheet: 1, row: 101, col: 3, json: {fm: "number", dfm: "0", data: "21"}},
            {sheet: 1, row: 102, col: 1, json: {data: "13-2）"}},
            {sheet: 1, row: 102, col: 2, json: {data: "人工费/只 "}},
            {sheet: 1, row: 102, col: 3, json: {fm: "money|¥|2|none", cal: true, data: "=C101/3600*35"}},
            {sheet: 1, row: 103, col: 1, json: {data: "13-3）"}},
            {sheet: 1, row: 103, col: 2, json: {data: "包材费： "}},
            {sheet: 1, row: 103, col: 3, json: {data: "0.35"}},
            ...
            {sheet: 1, row: 108, col: 3, json: {fm: "money|¥|2|none", data: "0"}},
            {sheet: 1, row: 109, col: 1, json: {data: "* "}},
            {sheet: 1, row: 109, col: 2, json: {data: "组装费： "}},
            {sheet: 1, row: 109, col: 3, json: {fm: "money|¥|2|none", data: "0"}},
