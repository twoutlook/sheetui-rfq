...
//        var ddlMaterial = {data: "xxx", drop: Ext.encode({data: "xxx,yyy,zzz"})};
        var ddlMaterial = {ta: "center", data: "一。铝合金", drop: Ext.encode({data: "一。铝合金,AlSi10Mg,AlSi9Cu3,ADC12,A380,A413,A360,A356,二。锌合金 ,ZINC-2,ZINC-3,ZINC-5,ZINC-7,ZAMAK-8,三。镁合金 ,AZ91D,AM60,THX-AZ91D,THX-AM60"})};
        var ddlSurface = {ta: "center", data: "单清洗", drop: Ext.encode({data: "单清洗,烤漆前皮膜（含清洗）,铝合金一般皮膜（48H）,锌合金一般皮膜（48H),镁合金一般皮膜（24H),铝合金-特殊皮膜（   H）,锌合金-特殊皮膜（   H) ,特殊导电皮膜(  欧姆) ,粉體烤漆-A+級,粉體烤漆-A級 ,粉體烤漆-B級 ,液體烤漆-A+級 ,液體烤漆-A級 ,液體烤漆-B級 ,阳极氧化-A级 , 阳极氧化-B级 ,电泳-A级,电泳-B级 ,掛鍍-A級,掛鍍-B 級,滾鍍-A級,滾鍍-B級 ,高清洁度清洗（600um）,高清洁度清洗（400um）,高清洁度清洗（200um）"})};
        var ddlMachine = {ta: "center", data: "一。铝合金压铸合模费：", drop: Ext.encode({data: "一。铝合金压铸合模费：,铝-125T,鋁-150T/160T/200T,鋁-250T/280T,鋁-350T/340T/400T,鋁-550T/530T/500T,鋁-630T/650T,鋁-800T/900T,鋁-1250T,鋁-1600T,鋁-2000T,鋁-2500T,鋁-3000T,二。锌合金压铸合模费：,鋅-快速机/4轴机,鋅-10T/5T,鋅-15T/20T,鋅-25T/30T/40T,鋅-50T/60T,鋅-80T/100T/125,鋅-150T,鋅-185/200T,鋅-250T,鋅-300T,三。镁合金压铸合模费：,鎂-150T,鎂-340T/400T,鎂-530T/660T,THX-鎂280T,THX-鎂650T"})};
//DOING...喷沙sand blasting 抛丸.震动研磨
        var ddlSand = {ta: "center", data: "===喷砂,抛丸,震动研磨===", drop: Ext.encode({data: "喷砂,抛丸,震动研磨"})};

        var ddlStep9 = {ta: "center", data: "===皮膜处理： ===", drop: Ext.encode({data: "烤漆前清洗皮膜,一般清洗加皮膜,特殊要求皮膜,清洗,特殊清洗"})};
...
//                    {sheet: 1, row: 2, col: 3, json: {data: "0"}},
                    ...
                    {sheet: 1, row: 11, col: 3, json: {fm: "number", data: "13"}},
                    ...
                    {sheet: 1, row: 33, col: 3, json: {fm: "number", data: "350"}},
                    {sheet: 1, row: 34, col: 1, json: {data: "1-6）"}},
                    {sheet: 1, row: 34, col: 2, json: {data: "料柄流道渣包比率 ： "}},
                    {sheet: 1, row: 34, col: 3, json: {fm: "number", data: "=(C31*C16)/(C31*C16+C33)"}},
            ...
            demo003: {
                fileName: "項目001-demo003",
                sheets: [{id: 1, name: "RFQ001", actived: true, color: "orange"}, {id: 2, name: "LOOKUP", actived: true, color: "blue"}, {id: 5, name: "LOOKUP04", actived: true, color: "blue"}],
//        floatings: [
//            {sheet: 1, name: "colGroups", ftype: "colgroup", json: "[{level:1, span:[2,3]}, {level:1, span:[4,6]}]"},
//        ],
                cells: [
                    ...
                    {sheet: 5, row: 0, col: 2, json: {ta: "center", data: "B", width: 100}},
                    ...
                    {sheet: 5, row: 17, col: 1, json: {data: '筛选&包装'}},
                    ...
                    {sheet: 2, row: 0, col: 0, json: {height: 20, va: "middle"}},
                    {sheet: 2, row: 0, col: 1, json: {data: "A", width: 200}},
                    {sheet: 2, row: 0, col: 2, json: {data: "B", width: 100}},
                    {sheet: 2, row: 0, col: 3, json: {data: "C", width: 100}},
                    ...
                    {sheet: 2, row: 1, col: 4, json: {ta: 'center', dsd: 'ed', data: '压铸合模费：'}},
                    {sheet: 2, row: 2, col: 4, json: {ta: 'center', dsd: 'ed', data: '一。铝合金压铸合模费：'}},
                    {sheet: 2, row: 3, col: 4, json: {ta: 'center', dsd: 'ed', data: '铝-125T'}},
                    {sheet: 2, row: 4, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-150T/160T/200T'}},
                    {sheet: 2, row: 5, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-250T/280T'}},
                    {sheet: 2, row: 6, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-350T/340T/400T'}},
                    {sheet: 2, row: 7, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-550T/530T/500T'}},
                    {sheet: 2, row: 8, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-630T/650T'}},
                    {sheet: 2, row: 9, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-800T/900T'}},
                    {sheet: 2, row: 10, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-1250T'}},
                    {sheet: 2, row: 11, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-1600T'}},
                    {sheet: 2, row: 12, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-2000T'}},
                    {sheet: 2, row: 13, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-2500T'}},
                    {sheet: 2, row: 14, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋁-3000T'}},
                    {sheet: 2, row: 15, col: 4, json: {ta: 'center', dsd: 'ed', data: '二。锌合金压铸合模费：'}},
                    {sheet: 2, row: 16, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-快速机/4轴机'}},
                    {sheet: 2, row: 17, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-10T/5T'}},
                    {sheet: 2, row: 18, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-15T/20T'}},
                    {sheet: 2, row: 19, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-25T/30T/40T'}},
                    {sheet: 2, row: 20, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-50T/60T'}},
                    {sheet: 2, row: 21, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-80T/100T/125'}},
                    {sheet: 2, row: 22, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-150T'}},
                    {sheet: 2, row: 23, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-185/200T'}},
                    {sheet: 2, row: 24, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-250T'}},
                    {sheet: 2, row: 25, col: 4, json: {ta: 'center', dsd: 'ed', data: '鋅-300T'}},
                    {sheet: 2, row: 26, col: 4, json: {ta: 'center', dsd: 'ed', data: '三。镁合金压铸合模费：'}},
                    {sheet: 2, row: 27, col: 4, json: {ta: 'center', dsd: 'ed', data: '鎂-150T'}},
                    {sheet: 2, row: 28, col: 4, json: {ta: 'center', dsd: 'ed', data: '鎂-340T/400T'}},
                    {sheet: 2, row: 29, col: 4, json: {ta: 'center', dsd: 'ed', data: '鎂-530T/660T'}},
                    {sheet: 2, row: 30, col: 4, json: {ta: 'center', dsd: 'ed', data: 'THX-鎂280T'}},
                    {sheet: 2, row: 31, col: 4, json: {ta: 'center', dsd: 'ed', data: 'THX-鎂650T'}},
                    {sheet: 2, row: 1, col: 5, json: {ta: 'center', dsd: 'ed', data: '壓鑄機台費率/H'}},
                    {sheet: 2, row: 2, col: 5, json: {ta: 'center', dsd: 'ed', data: ''}},
                    {sheet: 2, row: 3, col: 5, json: {ta: 'center', dsd: 'ed', data: '150'}},
                    {sheet: 2, row: 4, col: 5, json: {ta: 'center', dsd: 'ed', data: '165'}},
                    {sheet: 2, row: 5, col: 5, json: {ta: 'center', dsd: 'ed', data: '185'}},
                    {sheet: 2, row: 6, col: 5, json: {ta: 'center', dsd: 'ed', data: '210'}},
                    {sheet: 2, row: 7, col: 5, json: {ta: 'center', dsd: 'ed', data: '260'}},
                    {sheet: 2, row: 8, col: 5, json: {ta: 'center', dsd: 'ed', data: '320'}},
                    {sheet: 2, row: 9, col: 5, json: {ta: 'center', dsd: 'ed', data: '430'}},
                    {sheet: 2, row: 10, col: 5, json: {ta: 'center', dsd: 'ed', data: '500'}},
                    {sheet: 2, row: 11, col: 5, json: {ta: 'center', dsd: 'ed', data: '715'}},
                    {sheet: 2, row: 12, col: 5, json: {ta: 'center', dsd: 'ed', data: '915'}},
                    {sheet: 2, row: 13, col: 5, json: {ta: 'center', dsd: 'ed', data: '990'}},
                    {sheet: 2, row: 14, col: 5, json: {ta: 'center', dsd: 'ed', data: '1110'}},
                    {sheet: 2, row: 15, col: 5, json: {ta: 'center', dsd: 'ed', data: ' '}},
                    {sheet: 2, row: 16, col: 5, json: {ta: 'center', dsd: 'ed', data: '85'}},
                    {sheet: 2, row: 17, col: 5, json: {ta: 'center', dsd: 'ed', data: '60'}},
                    {sheet: 2, row: 18, col: 5, json: {ta: 'center', dsd: 'ed', data: '80'}},
                    {sheet: 2, row: 19, col: 5, json: {ta: 'center', dsd: 'ed', data: '120'}},
                    {sheet: 2, row: 20, col: 5, json: {ta: 'center', dsd: 'ed', data: '135'}},
                    {sheet: 2, row: 21, col: 5, json: {ta: 'center', dsd: 'ed', data: '160'}},
                    {sheet: 2, row: 22, col: 5, json: {ta: 'center', dsd: 'ed', data: '170'}},
                    {sheet: 2, row: 23, col: 5, json: {ta: 'center', dsd: 'ed', data: '185'}},
                    {sheet: 2, row: 24, col: 5, json: {ta: 'center', dsd: 'ed', data: '200'}},
                    {sheet: 2, row: 25, col: 5, json: {ta: 'center', dsd: 'ed', data: '215'}},
                    {sheet: 2, row: 26, col: 5, json: {ta: 'center', dsd: 'ed', data: ''}},
                    {sheet: 2, row: 27, col: 5, json: {ta: 'center', dsd: 'ed', data: '275'}},
                    {sheet: 2, row: 28, col: 5, json: {ta: 'center', dsd: 'ed', data: '350'}},
                    {sheet: 2, row: 29, col: 5, json: {ta: 'center', dsd: 'ed', data: '430'}},
                    {sheet: 2, row: 30, col: 5, json: {ta: 'center', dsd: 'ed', data: '320'}},
                    {sheet: 2, row: 31, col: 5, json: {ta: 'center', dsd: 'ed', data: '430'}},
                    {sheet: 1, row: 0, col: 0, json: {dsd: "", height: 20, va: "middle"}},
                    {sheet: 1, row: 0, col: 1, json: {ta: "center", dsd: "ed", data: "A", width: 50}},
                    {sheet: 1, row: 0, col: 2, json: {ta: "center", dsd: "ed", data: "B", width: 200}},
                    {sheet: 1, row: 0, col: 3, json: {dsd: "", data: "C", width: 200}},
                    {sheet: 1, row: 0, col: 4, json: {dsd: "", data: "D", width: 200}},
                    {sheet: 1, row: 0, col: 5, json: {dsd: "", data: "E", width: 200}},
                    {sheet: 1, row: 0, col: 6, json: {dsd: "", data: "F", width: 200}},
                    {sheet: 1, row: 0, col: 7, json: {dsd: "", data: "G", width: 200}},
                    {sheet: 1, row: 0, col: 8, json: {dsd: "", data: "I", width: 200}},
                    {sheet: 1, row: 1, col: 1, json: {data: ""}},
                    {sheet: 1, row: 1, col: 2, json: {data: ""}},
...
//                    {sheet: 1, row: 2, col: 3, json: {data: "0"}},
     {sheet: 1, row: 2, col: 3, json: {data: "TODO 保存數據", it: "button", btnStyle: "color: #900; font-weight: bold;", onBtnClickFn: "CUSTOM_BUTTON_CLICK_CALLBACK_FN"}},
                    ...
                    {sheet: 1, row: 11, col: 1, json: {data: ""}},
                    {sheet: 1, row: 11, col: 2, json: {data: "产品单重（g）："}},
                    {sheet: 1, row: 11, col: 3, json: {data: "13"}},
                    {sheet: 1, row: 12, col: 1, json: {data: ""}},
                    {sheet: 1, row: 12, col: 2, json: {data: "表面要求： "}},
                    ...
                    {sheet: 1, row: 16, col: 1, json: {data: ""}},
                    {sheet: 1, row: 16, col: 2, json: {data: "模穴数 "}},
                    {sheet: 1, row: 16, col: 3, json: {fm: "number", data: "1"}},
                    {sheet: 1, row: 17, col: 1, json: {data: ""}},
                    {sheet: 1, row: 17, col: 2, json: {data: "侧滑模数/油压抽芯数 "}},
                    ...
                    {sheet: 1, row: 19, col: 1, json: {data: ""}},
                    {sheet: 1, row: 19, col: 2, json: {data: "压铸模费用： "}},
                    {sheet: 1, row: 19, col: 3, json: {fm: "money|¥|2|none", data: "71500"}},
                    {sheet: 1, row: 20, col: 1, json: {data: ""}},
                    {sheet: 1, row: 20, col: 2, json: {data: "切边模费用： "}},
                    {sheet: 1, row: 20, col: 3, json: {fm: "money|¥|2|none", data: "12000"}},
                    {sheet: 1, row: 21, col: 1, json: {data: ""}},
                    {sheet: 1, row: 21, col: 2, json: {data: "加工夹治具费用： "}},
                    {sheet: 1, row: 21, col: 3, json: {fm: "money|¥|2|none", data: "8000"}},
                    {sheet: 1, row: 22, col: 1, json: {data: ""}},
                    {sheet: 1, row: 22, col: 2, json: {data: "烤漆夹治具费用： "}},
                    {sheet: 1, row: 22, col: 3, json: {fm: "money|¥|2|none", data: "8000"}},
                    {sheet: 1, row: 23, col: 1, json: {data: ""}},
                    {sheet: 1, row: 23, col: 2, json: {data: "模具总价（人民币）： "}},
                    {sheet: 1, row: 23, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C19+C20+C21+C22)"}},
                    {sheet: 1, row: 24, col: 1, json: {data: ""}},
                    {sheet: 1, row: 24, col: 2, json: {data: "模具总价（USD）： "}},
                    ...
                    {sheet: 1, row: 30, col: 1, json: {data: "1-2）"}},
                    {sheet: 1, row: 30, col: 2, json: {data: "材料单价/KG :"}},
                    {sheet: 1, row: 30, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=VLOOKUP(C10,LOOKUP!A3:C20,2,0)"}},
                    {sheet: 1, row: 31, col: 1, json: {data: "1-3）"}},
                    {sheet: 1, row: 31, col: 2, json: {data: "单重（g）："}},
                    ...
                    {sheet: 1, row: 35, col: 1, json: {data: "1-7）"}},
                    {sheet: 1, row: 35, col: 2, json: {data: "料柄流道渣包等废料价格/Kg： "}},
                    {sheet: 1, row: 35, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=VLOOKUP(C10,LOOKUP!A3:C20,3,0)"}},
                    {sheet: 1, row: 36, col: 1, json: {data: "1-8）"}},
                    {sheet: 1, row: 36, col: 2, json: {data: "料柄流道渣包回收价差损失额 ： "}},
                    ...
                    {sheet: 1, row: 38, col: 1, json: {data: ""}},
                    {sheet: 1, row: 38, col: 2, json: {data: "材料费　小计： "}},
                    {sheet: 1, row: 38, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C32+C36+C37)"}},
                    {sheet: 1, row: 39, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 39, col: 2, json: {data: "2)压铸费(含切边）： "}},
                    {sheet: 1, row: 39, col: 3, json: {data: "0"}},
                    {sheet: 1, row: 40, col: 1, json: {data: "2-1）"}},
                    ...
                    {sheet: 1, row: 41, col: 1, json: {data: "2-2）"}},
                    {sheet: 1, row: 41, col: 2, json: {data: "设备费率/H： "}},
                    {sheet: 1, row: 41, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=VLOOKUP(C40,LOOKUP!D3:E31,2,0)"}},
                    {sheet: 1, row: 42, col: 1, json: {data: "2-3）"}},
                    {sheet: 1, row: 42, col: 2, json: {data: "工时（秒）/只 ："}},
                    {sheet: 1, row: 42, col: 3, json: {data: "30"}},
                    {sheet: 1, row: 43, col: 1, json: {data: "2-4）"}},
                    {sheet: 1, row: 43, col: 2, json: {data: "产能 只/H ："}},
                    ...
                    {sheet: 1, row: 45, col: 1, json: {data: "2-6）"}},
                    {sheet: 1, row: 45, col: 2, json: {bgc: "pink", data: "人工费/只 ***待確認： "}},
                    {sheet: 1, row: 45, col: 3, json: {data: "0"}},
                    {sheet: 1, row: 46, col: 1, json: {data: "2-7）"}},
                    ...
                    {sheet: 1, row: 47, col: 1, json: {data: "2-8）"}},
                    {sheet: 1, row: 47, col: 2, json: {data: "良品率： "}},
                    {sheet: 1, row: 47, col: 3, json: {fm: "number", dfm: "0%", data: "95"}},
                    {sheet: 1, row: 48, col: 1, json: {data: ""}},
                    {sheet: 1, row: 48, col: 2, json: {data: "压铸费　小计： "}},
                    {sheet: 1, row: 48, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C44+C45)*(1+(1-C47/100))/C16"}},
                    {sheet: 1, row: 49, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 49, col: 2, json: {data: "3)毛刺处理费（含粗磨）"}},
                    {sheet: 1, row: 49, col: 3, json: {data: ""}},
                    {sheet: 1, row: 50, col: 1, json: {data: "3-1）"}},
                    {sheet: 1, row: 50, col: 2, json: {data: "工时（秒）/只 ： "}},
                    {sheet: 1, row: 50, col: 3, json: {data: "82"}},
                    {sheet: 1, row: 51, col: 1, json: {data: "3-2）"}},
                    {sheet: 1, row: 51, col: 2, json: {data: "人工费率/H： "}},
                    {sheet: 1, row: 51, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", data: "35"}},
                    {sheet: 1, row: 52, col: 1, json: {data: ""}},
                    {sheet: 1, row: 52, col: 2, json: {data: "毛刺处理费　小计： "}},
                    {sheet: 1, row: 52, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C50/3600)*C51"}},
                    {sheet: 1, row: 53, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 53, col: 2, json: {data: "4)外观打磨费（入/溢料口, 分模线及一般外观瑕疵等部位做打磨）"}},
                    {sheet: 1, row: 53, col: 3, json: {data: ""}},
                    {sheet: 1, row: 54, col: 1, json: {data: "4-1）"}},
                    {sheet: 1, row: 54, col: 2, json: {data: "工时（秒）/只 ： "}},
                    {sheet: 1, row: 54, col: 3, json: {data: "150"}},
                    {sheet: 1, row: 55, col: 1, json: {data: "4-2）"}},
                    {sheet: 1, row: 55, col: 2, json: {data: "人工费率/H： "}},
                    {sheet: 1, row: 55, col: 3, json: {data: "45"}},
                    {sheet: 1, row: 56, col: 1, json: {data: "4-3）"}},
                    ...
                    {sheet: 1, row: 57, col: 1, json: {data: "4-4）"}},
                    {sheet: 1, row: 57, col: 2, json: {data: "良品率： "}},
                    {sheet: 1, row: 57, col: 3, json: {fm: "number", dfm: "0%", data: "99"}},
                    {sheet: 1, row: 58, col: 1, json: {data: ""}},
                    {sheet: 1, row: 58, col: 2, json: {data: ""}},
                    {sheet: 1, row: 58, col: 3, json: {data: ""}},
                    {sheet: 1, row: 59, col: 1, json: {data: ""}},
                    {sheet: 1, row: 59, col: 2, json: {data: "外观打磨费　小计："}},
                    {sheet: 1, row: 59, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=C56*(1+(1-C57/100))"}},
                    {sheet: 1, row: 60, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 60, col: 2, json: {data: "5)平整度整形费 "}},
                    {sheet: 1, row: 60, col: 3, json: {data: ""}},
                    {sheet: 1, row: 61, col: 1, json: {data: "5-1）"}},
                    {sheet: 1, row: 61, col: 2, json: {data: "工时（秒）/只 ： "}},
                    {sheet: 1, row: 61, col: 3, json: {data: "60"}},
                    {sheet: 1, row: 62, col: 1, json: {data: "5-2）"}},
                    {sheet: 1, row: 62, col: 2, json: {data: "人工费率/H： "}},
                    ...
                    {sheet: 1, row: 64, col: 1, json: {data: ""}},
                    {sheet: 1, row: 64, col: 2, json: {data: "平整度整形费　小计： "}},
                    {sheet: 1, row: 64, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C61/3600)*C62"}},
                    {sheet: 1, row: 65, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 65, col: 2, json: {data: "6)机加工 "}},
                    {sheet: 1, row: 65, col: 3, json: {data: ""}},
                    {sheet: 1, row: 66, col: 1, json: {data: "6-1）"}},
                    ...
                    {sheet: 1, row: 67, col: 1, json: {data: "6-2）"}},
                    {sheet: 1, row: 67, col: 2, json: {data: "傳統机加工费率/H： "}},
                    {sheet: 1, row: 67, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", data: "50"}},
                    {sheet: 1, row: 68, col: 1, json: {data: "6-3）"}},
                    {sheet: 1, row: 68, col: 2, json: {data: "傳統机加工良品率： "}},
                    {sheet: 1, row: 68, col: 3, json: {fm: "number", dfm: "0%", data: "95"}},
                    {sheet: 1, row: 69, col: 1, json: {data: ""}},
                    {sheet: 1, row: 69, col: 2, json: {data: "机加工　小计： "}},
                    {sheet: 1, row: 69, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C66/3600)*C67 * (1 + (1 - C68 / 100))"}},
                    {sheet: 1, row: 70, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 70, col: 2, json: {data: "7)冷喷.热烧毛刺 &费率/分： "}},
                    {sheet: 1, row: 70, col: 3, json: {data: ""}},
                    {sheet: 1, row: 71, col: 1, json: {data: "7-1）"}},
                    {sheet: 1, row: 71, col: 2, json: {data: "工时（秒）/只 ： "}},
                    {sheet: 1, row: 71, col: 3, json: {fm: "number", dfm: "0", data: "60"}},
                    {sheet: 1, row: 72, col: 1, json: {data: "7-2）"}},
                    {sheet: 1, row: 72, col: 2, json: {data: "加工费率/H： "}},
                    {sheet: 1, row: 72, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", data: "35"}},
                    {sheet: 1, row: 73, col: 1, json: {data: ""}},
                    {sheet: 1, row: 73, col: 2, json: {data: "冷喷热烧毛刺　小计："}},
                    {sheet: 1, row: 73, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C71/3600)*C72"}},
                    {sheet: 1, row: 74, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 74, col: 2, json: {data: "8)喷沙.抛丸.震动研磨 &费率 "}},
                    {sheet: 1, row: 74, col: 3, json: ddlSand},
                    {sheet: 1, row: 75, col: 1, json: {data: "8-1）"}},
                    {sheet: 1, row: 75, col: 2, json: {data: "工时（秒）/只 ： "}},
                    {sheet: 1, row: 75, col: 3, json: {data: "60"}},
                    {sheet: 1, row: 76, col: 1, json: {data: "8-2）"}},
                    {sheet: 1, row: 76, col: 2, json: {data: "加工费率/H： "}},
                    {sheet: 1, row: 76, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=VLOOKUP(C74,LOOKUP04!A2:B17,2,0)"}},
                    {sheet: 1, row: 77, col: 1, json: {data: ""}},
                    {sheet: 1, row: 77, col: 2, json: {data: "喷沙抛丸震动研磨　小计： "}},
                    {sheet: 1, row: 77, col: 3, json: {fm: "money|¥|2|none", dsd: "ed", cal: true, data: "=(C75/3600)*C76"}},
                    {sheet: 1, row: 78, col: 1, json: {data: "* "}},
                    {sheet: 1, row: 78, col: 2, json: {data: "9)皮膜处理 &费率 "}},
                    {sheet: 1, row: 78, col: 3, json: {data: "0"}},
                    {sheet: 1, row: 79, col: 1, json: {data: "9-1）"}},
                    ...
                    {sheet: 1, row: 80, col: 1, json: {data: "9-2）"}},
                    {sheet: 1, row: 80, col: 2, json: {data: "工件表面面积 (算单面）DM2： "}},
                    {sheet: 1, row: 80, col: 3, json: {fm: "number", dfm: "0.00", data: "0.99"}},
                    {sheet: 1, row: 81, col: 1, json: {data: "9-3）"}},
                    {sheet: 1, row: 81, col: 2, json: {data: "加工费率/H： "}},
                    {sheet: 1, row: 81, col: 3, json:{fm: "money|¥|2|none",  cal: true, data: "0.88"}},
                    {sheet: 1, row: 82, col: 1, json: {data: ""}},
                    {sheet: 1, row: 82, col: 2, json: {data: "皮膜处理　小计： "}},
                    {sheet: 1, row: 82, col: 3, json: {data: "0"}},
                    {sheet: 1, row: 83, col: 1, json: {data: ""}},
                    ...
                    {sheet: 1, row: 85, col: 1, json: {data: "10-1）"}},
                    {sheet: 1, row: 85, col: 2, json: {data: "表面要求"}},
                    {sheet: 1, row: 85, col: 3, json: {dsd: "ed", cal: true, data: "=C12"}},
                    {sheet: 1, row: 86, col: 1, json: {data: "10-2）"}},
                    {sheet: 1, row: 86, col: 2, json: {data: "工件表面积(算需喷漆面积）DM2： "}},
                    {sheet: 1, row: 86, col: 3, json: {data: "0"}},
                    {sheet: 1, row: 87, col: 1, json: {data: "10-3）"}},
            ...
            filterCellsJson: {
                ...
                cells: [
                    ...
                    {sheet: 1, row: 4, col: 2, json: {data: "CATEGORY"}},
                    {sheet: 1, row: 4, col: 3, json: {data: "ESTIMATED"}},
                    {sheet: 1, row: 4, col: 4, json: {data: "ACTUAL", plain: 1, trigger: "ss-filter ss-filtered-trigger"}},
                    {sheet: 1, row: 5, col: 2, json: {data: "Bouquets"}},
                    {sheet: 1, row: 5, col: 3, json: {data: "500"}},
                    {sheet: 1, row: 5, col: 4, json: {data: "450"}},
                    {sheet: 1, row: 6, col: 2, json: {data: "Boutonnires"}},
                    {sheet: 1, row: 6, col: 3, json: {data: "200"}},
                    {sheet: 1, row: 6, col: 4, json: {data: "150"}},
                    {sheet: 1, row: 7, col: 2, json: {data: "Corsages"}},
                    {sheet: 1, row: 7, col: 3, json: {data: "100"}},
                    {sheet: 1, row: 7, col: 4, json: {data: "80"}},
                    {sheet: 1, row: 8, col: 2, json: {data: "Flowers"}},
                    {sheet: 1, row: 8, col: 3, json: {data: "300"}},
                    {sheet: 1, row: 8, col: 4, json: {data: "300"}},
                    {sheet: 1, row: 3, col: 6, json: {data: "Filter"}},
                    {sheet: 1, row: 4, col: 6, json: {data: "100"}},
                    {sheet: 1, row: 5, col: 6, json: {data: "120"}},
                    {sheet: 1, row: 6, col: 6, json: {data: "150"}},
                    {sheet: 1, row: 7, col: 6, json: {data: "200"}},
                    {sheet: 1, row: 8, col: 6, json: {data: "300"}},
                    {sheet: 1, row: 10, col: 6, json: {data: "Click and add filter", it: "button", btnStyle: "color: #FFF; background-color: #900;font-size: 105%;", onBtnClickFn: "BTN_ADD_FILTER_CALLBACK_FN"}},
                    {sheet: 1, row: 12, col: 6, json: {data: "Remove filter", it: "button", btnStyle: "color: #FFF; background-color: #900;font-size: 105%;", onBtnClickFn: "BTN_REMOVE_FILTER_CALLBACK_FN"}}
                ]
            },
            sortCellsJson: {
            ...
            featureCheckboxJson: {
                ...
                cells: [
                    ...
                    {sheet: 1, row: 8, col: 5, json: {data: "Indent", it: "checkbox", itn: "checkonly", itchk: false, ti: "10px"}},
                    ...
                    {sheet: 1, row: 8, col: 10, json: {data: "Indent", it: "radio", itn: "radioOnly", itchk: false, ti: "10px"}}
                ]
            },
            /**
             * This is the checkbox/Radio json example to show how to create them by calling EnterpiseSheet API.
            ...
            featureCellAlignJson: {
                ...
                cells: [
                    ...
                    {sheet: 1, row: 7, col: 2, json: {data: "indent 10 px", ti: "10px"}},
                    {sheet: 1, row: 8, col: 2, json: {data: "indent 20 px", ti: "20px"}},
            ...
            featureColDataTypeJson: {
                ...
                cells: [
                    ...
                    {sheet: 1, row: 1, col: 2, json: {data: 'Dave Smith'}},
                    {sheet: 1, row: 1, col: 3, json: {render: 'dropRender', data: 'Software Dept', dropId: 2}},
                    {sheet: 1, row: 1, col: 4, json: {data: 'dave.smith@abc.com'}},
                    {sheet: 1, row: 1, col: 5, json: {data: '1 (888) 231-7654'}},
