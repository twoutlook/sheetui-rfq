...
Ext.define('enterpriseSheet.demo.WestPanel', {
    ...
    initComponent: function () {
        ...
        children.push({text: 'RFQ功能需求', cls: 'folder', expanded: true, children: features});
        children.push({text: '項目要點', cls: 'folder', expanded: false, children: callbackFn});
        if (!SCONFIG.js_standalone) {
