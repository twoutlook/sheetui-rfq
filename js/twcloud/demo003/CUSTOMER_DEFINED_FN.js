...
;
function CELL_ON_BLUR_CALLBACK_FN001(value, row, column, sheetId, cellObj, store) {
    alert("客製Cell value: " + value + "; Row: " + row + "; Colum: " + column);
}
;
/**
...
function CELL_CLICK_CALLBACK_FN_001(value, row, column) {
//    alert("客製...Cell value: " + value + "; Row: " + row + "; Colum: " + column);
...
function CUSTOM_BINDING_DATA_FN(jsonData, row, column) {
    ...
    if (jsonData.data.lastIndexOf("Apple") === 0)
        html = '<table><tr><td><img src="http://iconizer.net/files/WPZOOM_Social_Networking_Icon_Set/orig/apple.png"></td><td valign="top"><b>Apple Inc.</b><br/>1 Infinite Loop<br/>Cupertino, CA 95014<br/>Id: ' + id + '</td></tr></table>';
    if (jsonData.data.lastIndexOf("Google") === 0)
        html = '<table><tr><td><img src="http://www.google.com/homepage/images/google_favicon_64.png"></td><td valign="top"><b>Google Inc.</b><br/>1600 Amphitheatre Parkway<br/>Mountain View, CA 94043<br/>Id: ' + id + '</td></tr></table>';
    if (jsonData.data.lastIndexOf("Taylor") === 0)
        html = '<table><tr><td><img src="http://38.media.tumblr.com/avatar_d4bf27a2bc43_64.png"></td><td valign="top"><b>Tayor Swift</b><br/>December 13, 1989<br/>West Reading, Pennsylvania, USA<br/>Id: ' + id + '</td></tr></table>';
