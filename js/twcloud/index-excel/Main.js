...
//
// ------------ mark-tool-mainjs.php auto generate (start)  ---------------
//
{sheet: 1, row: 12, col: 3, json: ddlSurface},
{sheet: 1, row: 10, col: 3, json: ddlMaterial},
{sheet: 1, row: 40, col: 3, json: ddlMachine},
...
{sheet: 1, row: 79, col: 4, json: ddlStep9},
...
{sheet: 1, row: 79, col: 5, json: ddlStep9},
...
{sheet: 1, row: 79, col: 6, json: ddlStep9},
...
{sheet: 1, row: 79, col: 7, json: ddlStep9},
...
{sheet: 1, row: 79, col: 8, json: ddlStep9},
{sheet: 1, row: 23, col: 3, json: styleSubTotal({data: '=(C19+C20+C21+C22)'})},
...
{sheet: 1, row: 30, col: 3,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(C10,LOOKUP!$A$3:$C$20,2,0)'}},
{sheet: 1, row: 30, col: 4,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(D10,LOOKUP!$A$3:$C$20,2,0)'}},
{sheet: 1, row: 30, col: 5,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(E10,LOOKUP!$A$3:$C$20,2,0)'}},
{sheet: 1, row: 30, col: 6,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(F10,LOOKUP!$A$3:$C$20,2,0)'}},
{sheet: 1, row: 30, col: 7,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(G10,LOOKUP!$A$3:$C$20,2,0)'}},
{sheet: 1, row: 30, col: 8,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(H10,LOOKUP!$A$3:$C$20,2,0)'}},
{sheet: 1, row: 31, col: 3,json: {dsd: 'ed', data: '=C11', cal: true}},
...
{sheet: 1, row: 35, col: 3,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(C10,LOOKUP!$A$3:$C$20,3,0)'}},
{sheet: 1, row: 35, col: 4,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(D10,LOOKUP!$A$3:$C$20,3,0)'}},
{sheet: 1, row: 35, col: 5,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(E10,LOOKUP!$A$3:$C$20,3,0)'}},
{sheet: 1, row: 35, col: 6,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(F10,LOOKUP!$A$3:$C$20,3,0)'}},
{sheet: 1, row: 35, col: 7,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(G10,LOOKUP!$A$3:$C$20,3,0)'}},
{sheet: 1, row: 35, col: 8,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(H10,LOOKUP!$A$3:$C$20,3,0)'}},
{sheet: 1, row: 36, col: 3,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=(C30-C35)*C33/1000/C16'}},
...
{sheet: 1, row: 41, col: 3,json: styleSubTotal({data: '=IF(ISNA(C32+C36+C37),0,(C32+C36+C37))'})},
{sheet: 1, row: 41, col: 4,json: styleSubTotal({data: '=IF(ISNA(D32+D36+D37),0,(D32+D36+D37))'})},
{sheet: 1, row: 41, col: 5,json: styleSubTotal({data: '=IF(ISNA(E32+E36+E37),0,(E32+E36+E37))'})},
{sheet: 1, row: 41, col: 6,json: styleSubTotal({data: '=IF(ISNA(F32+F36+F37),0,(F32+F36+F37))'})},
{sheet: 1, row: 41, col: 7,json: styleSubTotal({data: '=IF(ISNA(G32+G36+G37),0,(G32+G36+G37))'})},
{sheet: 1, row: 41, col: 8,json: styleSubTotal({data: '=IF(ISNA(H32+H36+H37),0,(H32+H36+H37))'})},
{sheet: 1, row: 43, col: 3,json: {fm: 'number', dfm: '0', dsd: 'ed', cal: true, data: '=3600/C42'}},
{sheet: 1, row: 43, col: 4,json: {fm: 'number', dfm: '0', dsd: 'ed', cal: true, data: '=3600/D42'}},
{sheet: 1, row: 43, col: 5,json: {fm: 'number', dfm: '0', dsd: 'ed', cal: true, data: '=3600/E42'}},
{sheet: 1, row: 43, col: 6,json: {fm: 'number', dfm: '0', dsd: 'ed', cal: true, data: '=3600/F42'}},
{sheet: 1, row: 43, col: 7,json: {fm: 'number', dfm: '0', dsd: 'ed', cal: true, data: '=3600/G42'}},
{sheet: 1, row: 43, col: 8,json: {fm: 'number', dfm: '0', dsd: 'ed', cal: true, data: '=3600/H42'}},
{sheet: 1, row: 44, col: 3,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=C41/C43'}},
{sheet: 1, row: 44, col: 4,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=D41/D43'}},
{sheet: 1, row: 44, col: 5,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=E41/E43'}},
{sheet: 1, row: 44, col: 6,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=F41/F43'}},
{sheet: 1, row: 44, col: 7,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=G41/G43'}},
{sheet: 1, row: 44, col: 8,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=H41/H43'}},
{sheet: 1, row: 45, col: 3,json: {fm: 'money|¥|2|none', dsd: 'ed', cal: true, data: '=VLOOKUP(C40,LOOKUP2!$A$1:$C$100,3,0)/C43'}},
...
{sheet: 1, row: 11, col: 3,json: styleInput({fm: 'number', data: '13'})},
{sheet: 1, row: 11, col: 4,json: styleInput({fm: 'number', data: '14'})},
{sheet: 1, row: 11, col: 5,json: styleInput({fm: 'number', data: '15'})},
{sheet: 1, row: 11, col: 6,json: styleInput({fm: 'number', data: '16'})},
{sheet: 1, row: 11, col: 7,json: styleInput({fm: 'number', data: '17'})},
{sheet: 1, row: 11, col: 8,json: styleInput({fm: 'number', data: '18'})},
{sheet: 1, row: 16, col: 3,json: styleInput({fm: 'number', data: '1'})},
{sheet: 1, row: 16, col: 4,json: styleInput({fm: 'number', data: '2'})},
{sheet: 1, row: 16, col: 5,json: styleInput({fm: 'number', data: '4'})},
{sheet: 1, row: 16, col: 6,json: styleInput({fm: 'number', data: '8'})},
{sheet: 1, row: 16, col: 7,json: styleInput({fm: 'number', data: '12'})},
{sheet: 1, row: 16, col: 8,json: styleInput({fm: 'number', data: '12'})},
{sheet: 1, row: 33, col: 3,json: styleInput({fm: 'number', data: '350'})},
{sheet: 1, row: 33, col: 4,json: styleInput({fm: 'number', data: '340'})},
{sheet: 1, row: 33, col: 5,json: styleInput({fm: 'number', data: '330'})},
{sheet: 1, row: 33, col: 6,json: styleInput({fm: 'number', data: '320'})},
{sheet: 1, row: 33, col: 7,json: styleInput({fm: 'number', data: '310'})},
{sheet: 1, row: 33, col: 8,json: styleInput({fm: 'number', data: '300'})},
{sheet: 1, row: 42, col: 3,json: styleInput({fm: 'number', data: '30'})},
{sheet: 1, row: 42, col: 4,json: styleInput({fm: 'number', data: '35'})},
{sheet: 1, row: 42, col: 5,json: styleInput({fm: 'number', data: '40'})},
{sheet: 1, row: 42, col: 6,json: styleInput({fm: 'number', data: '42'})},
{sheet: 1, row: 42, col: 7,json: styleInput({fm: 'number', data: '44'})},
{sheet: 1, row: 42, col: 8,json: styleInput({fm: 'number', data: '46'})},
{sheet: 1, row: 50, col: 3,json: styleInput({fm: 'number', data: '82'})},
{sheet: 1, row: 50, col: 4,json: styleInput({fm: 'number', data: '80'})},
{sheet: 1, row: 50, col: 5,json: styleInput({fm: 'number', data: '78'})},
{sheet: 1, row: 50, col: 6,json: styleInput({fm: 'number', data: '76'})},
{sheet: 1, row: 50, col: 7,json: styleInput({fm: 'number', data: '74'})},
{sheet: 1, row: 50, col: 8,json: styleInput({fm: 'number', data: '72'})},
{sheet: 1, row: 54, col: 3,json: styleInput({fm: 'number', data: '150'})},
{sheet: 1, row: 54, col: 4,json: styleInput({fm: 'number', data: '140'})},
{sheet: 1, row: 54, col: 5,json: styleInput({fm: 'number', data: '130'})},
{sheet: 1, row: 54, col: 6,json: styleInput({fm: 'number', data: '120'})},
{sheet: 1, row: 54, col: 7,json: styleInput({fm: 'number', data: '110'})},
{sheet: 1, row: 54, col: 8,json: styleInput({fm: 'number', data: '99'})},
{sheet: 1, row: 61, col: 3,json: styleInput({fm: 'number', data: '60'})},
{sheet: 1, row: 61, col: 4,json: styleInput({fm: 'number', data: '63'})},
{sheet: 1, row: 61, col: 5,json: styleInput({fm: 'number', data: '66'})},
{sheet: 1, row: 61, col: 6,json: styleInput({fm: 'number', data: '69'})},
{sheet: 1, row: 61, col: 7,json: styleInput({fm: 'number', data: '72'})},
{sheet: 1, row: 61, col: 8,json: styleInput({fm: 'number', data: '75'})},
{sheet: 1, row: 66, col: 3,json: styleInput({fm: 'number', data: '30'})},
{sheet: 1, row: 66, col: 4,json: styleInput({fm: 'number', data: '31'})},
{sheet: 1, row: 66, col: 5,json: styleInput({fm: 'number', data: '32'})},
{sheet: 1, row: 66, col: 6,json: styleInput({fm: 'number', data: '33'})},
{sheet: 1, row: 66, col: 7,json: styleInput({fm: 'number', data: '34'})},
{sheet: 1, row: 66, col: 8,json: styleInput({fm: 'number', data: '35'})},
{sheet: 1, row: 71, col: 3,json: styleInput({fm: 'number', data: '60'})},
{sheet: 1, row: 71, col: 4,json: styleInput({fm: 'number', data: '56'})},
{sheet: 1, row: 71, col: 5,json: styleInput({fm: 'number', data: '54'})},
{sheet: 1, row: 71, col: 6,json: styleInput({fm: 'number', data: '52'})},
{sheet: 1, row: 71, col: 7,json: styleInput({fm: 'number', data: '51'})},
{sheet: 1, row: 71, col: 8,json: styleInput({fm: 'number', data: '49'})},
{sheet: 1, row: 75, col: 3,json: styleInput({fm: 'number', data: '60'})},
{sheet: 1, row: 75, col: 4,json: styleInput({fm: 'number', data: '56'})},
{sheet: 1, row: 75, col: 5,json: styleInput({fm: 'number', data: '54'})},
{sheet: 1, row: 75, col: 6,json: styleInput({fm: 'number', data: '52'})},
{sheet: 1, row: 75, col: 7,json: styleInput({fm: 'number', data: '51'})},
{sheet: 1, row: 75, col: 8,json: styleInput({fm: 'number', data: '49'})},
{sheet: 1, row: 80, col: 3,json: styleInput({fm: 'number', data: '0.99'})},
{sheet: 1, row: 80, col: 4,json: styleInput({fm: 'number', data: '0.98'})},
{sheet: 1, row: 80, col: 5,json: styleInput({fm: 'number', data: '0.97'})},
{sheet: 1, row: 80, col: 6,json: styleInput({fm: 'number', data: '0.96'})},
{sheet: 1, row: 80, col: 7,json: styleInput({fm: 'number', data: '0.95'})},
{sheet: 1, row: 80, col: 8,json: styleInput({fm: 'number', data: '0.94'})},
{sheet: 1, row: 82, col: 3,json: styleInput({fm: 'number', data: '1'})},
{sheet: 1, row: 82, col: 4,json: styleInput({fm: 'number', data: '1.1'})},
{sheet: 1, row: 82, col: 5,json: styleInput({fm: 'number', data: '1.2'})},
{sheet: 1, row: 82, col: 6,json: styleInput({fm: 'number', data: '0.9'})},
{sheet: 1, row: 82, col: 7,json: styleInput({fm: 'number', data: '0.8'})},
{sheet: 1, row: 82, col: 8,json: styleInput({fm: 'number', data: '0.85'})},
{sheet: 1, row: 86, col: 3,json: styleInput({fm: 'number', data: '6'})},
{sheet: 1, row: 86, col: 4,json: styleInput({fm: 'number', data: '5'})},
{sheet: 1, row: 86, col: 5,json: styleInput({fm: 'number', data: '5.5'})},
{sheet: 1, row: 86, col: 6,json: styleInput({fm: 'number', data: '7'})},
{sheet: 1, row: 86, col: 7,json: styleInput({fm: 'number', data: '7.5'})},
{sheet: 1, row: 86, col: 8,json: styleInput({fm: 'number', data: '9'})},
{sheet: 1, row: 90, col: 3,json: styleInput({fm: 'number', data: '0.9'})},
{sheet: 1, row: 90, col: 4,json: styleInput({fm: 'number', data: '1'})},
{sheet: 1, row: 90, col: 5,json: styleInput({fm: 'number', data: '1.1'})},
{sheet: 1, row: 90, col: 6,json: styleInput({fm: 'number', data: '1.2'})},
{sheet: 1, row: 90, col: 7,json: styleInput({fm: 'number', data: '0.9'})},
{sheet: 1, row: 90, col: 8,json: styleInput({fm: 'number', data: '0.8'})},
{sheet: 1, row: 93, col: 3,json: styleInput({fm: 'number', data: '12'})},
{sheet: 1, row: 93, col: 4,json: styleInput({fm: 'number', data: '13'})},
{sheet: 1, row: 93, col: 5,json: styleInput({fm: 'number', data: '14'})},
{sheet: 1, row: 93, col: 6,json: styleInput({fm: 'number', data: '15'})},
{sheet: 1, row: 93, col: 7,json: styleInput({fm: 'number', data: '16'})},
{sheet: 1, row: 93, col: 8,json: styleInput({fm: 'number', data: '17'})},
{sheet: 1, row: 97, col: 3,json: styleInput({fm: 'number', data: '56'})},
{sheet: 1, row: 97, col: 4,json: styleInput({fm: 'number', data: '57'})},
{sheet: 1, row: 97, col: 5,json: styleInput({fm: 'number', data: '58'})},
{sheet: 1, row: 97, col: 6,json: styleInput({fm: 'number', data: '59'})},
{sheet: 1, row: 97, col: 7,json: styleInput({fm: 'number', data: '60'})},
{sheet: 1, row: 97, col: 8,json: styleInput({fm: 'number', data: '61'})},
{sheet: 1, row: 101, col: 3,json: styleInput({fm: 'number', data: '21'})},
{sheet: 1, row: 101, col: 4,json: styleInput({fm: 'number', data: '22'})},
{sheet: 1, row: 101, col: 5,json: styleInput({fm: 'number', data: '23'})},
{sheet: 1, row: 101, col: 6,json: styleInput({fm: 'number', data: '24'})},
{sheet: 1, row: 101, col: 7,json: styleInput({fm: 'number', data: '25'})},
{sheet: 1, row: 101, col: 8,json: styleInput({fm: 'number', data: '26'})},
{sheet: 1, row: 19, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '71500'})},
{sheet: 1, row: 19, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '81500'})},
{sheet: 1, row: 19, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '91500'})},
{sheet: 1, row: 19, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '61500'})},
{sheet: 1, row: 19, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '55500'})},
{sheet: 1, row: 19, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '44400'})},
{sheet: 1, row: 20, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '1200'})},
{sheet: 1, row: 20, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '1300'})},
{sheet: 1, row: 20, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '1400'})},
{sheet: 1, row: 20, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '1500'})},
{sheet: 1, row: 20, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '1600'})},
{sheet: 1, row: 20, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '1700'})},
{sheet: 1, row: 21, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '7600'})},
{sheet: 1, row: 21, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '7700'})},
{sheet: 1, row: 21, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '7800'})},
{sheet: 1, row: 21, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '7900'})},
{sheet: 1, row: 21, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '7100'})},
{sheet: 1, row: 21, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '7200'})},
{sheet: 1, row: 22, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '5600'})},
{sheet: 1, row: 22, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '55700'})},
{sheet: 1, row: 22, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '5800'})},
{sheet: 1, row: 22, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '5900'})},
{sheet: 1, row: 22, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '6000'})},
{sheet: 1, row: 22, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '6100'})},
{sheet: 1, row: 81, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.88'})},
{sheet: 1, row: 81, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.89'})},
{sheet: 1, row: 81, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.91'})},
{sheet: 1, row: 81, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.92'})},
{sheet: 1, row: 81, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.93'})},
{sheet: 1, row: 81, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.94'})},
{sheet: 1, row: 87, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.1'})},
{sheet: 1, row: 87, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.15'})},
{sheet: 1, row: 87, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.2'})},
{sheet: 1, row: 87, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.22'})},
{sheet: 1, row: 87, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.33'})},
{sheet: 1, row: 87, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.44'})},
{sheet: 1, row: 88, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.6'})},
{sheet: 1, row: 88, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.7'})},
{sheet: 1, row: 88, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.8'})},
{sheet: 1, row: 88, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.9'})},
{sheet: 1, row: 88, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.91'})},
{sheet: 1, row: 88, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.94'})},
{sheet: 1, row: 94, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.34'})},
{sheet: 1, row: 94, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.35'})},
{sheet: 1, row: 94, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.36'})},
{sheet: 1, row: 94, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.37'})},
{sheet: 1, row: 94, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.38'})},
{sheet: 1, row: 94, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.39'})},
{sheet: 1, row: 103, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.39'})},
{sheet: 1, row: 103, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.34'})},
{sheet: 1, row: 103, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.35'})},
{sheet: 1, row: 103, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.36'})},
{sheet: 1, row: 103, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.37'})},
{sheet: 1, row: 103, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.38'})},
{sheet: 1, row: 108, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.11'})},
{sheet: 1, row: 108, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.22'})},
{sheet: 1, row: 108, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.33'})},
{sheet: 1, row: 108, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.44'})},
{sheet: 1, row: 108, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.55'})},
{sheet: 1, row: 108, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.66'})},
{sheet: 1, row: 109, col: 3,json: styleInput({fm: 'money|¥|2|none', data: '0.66'})},
{sheet: 1, row: 109, col: 4,json: styleInput({fm: 'money|¥|2|none', data: '0.11'})},
{sheet: 1, row: 109, col: 5,json: styleInput({fm: 'money|¥|2|none', data: '0.22'})},
{sheet: 1, row: 109, col: 6,json: styleInput({fm: 'money|¥|2|none', data: '0.33'})},
{sheet: 1, row: 109, col: 7,json: styleInput({fm: 'money|¥|2|none', data: '0.44'})},
{sheet: 1, row: 109, col: 8,json: styleInput({fm: 'money|¥|2|none', data: '0.55'})},
{sheet: 1, row: 85, col: 3, json: {dsd: 'ed', ta: 'center', cal: true, data: '=C12'}},
