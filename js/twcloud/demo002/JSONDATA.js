 ...
 */
var ddl1Json={data:"xxx",drop:Ext.encode({data:"xxx,yyy,zzz"})};
...
//        ],
                cells: [
                    ...
                    {sheet: 1, row: 1, col: 1, json: {data: "=B1+C1", cal: true}},
...
//                    {sheet: 1, row: 2, col: 3, json: {data: "0"}},
                    ...
                    {sheet: 1, row: 2, col: 3, json: {data: "[ 保存數據 ]", onCellClickFn: "CELL_CLICK_CALLBACK_FN_001", fw: "bold"}},
                    ...
                    {sheet: 1, row: 10, col: 3, json:ddl1Jason},
